...
create_scatterplot <- function(route_data) {
  route_data |> 
  ggplot(aes(request_time_UTC, duration_minutes, color = direction, shape = weekend)) +
  geom_point() +
...
These travel time estimates are for the Park Street corridor between Badger and University. This route often sees m
